<div align="center">
  ...
  <h3><b>hello_rails_react_backend</b></h3>
...
# 📖 hello_rails_react_backend <a name="about-project"></a>

**hello_rails_react_backend** is app build using ruby on rails.
...
```sh
  cd my-folder
  https://github.com/jeanbuhendwa/hello-rails-back-end.git
```
